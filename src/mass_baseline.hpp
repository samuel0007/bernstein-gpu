...
namespace dolfinx::acc
{
  ...
  public:
    ...
    void init(std::span<const T> alpha)
    {
      ...
      constexpr int nq = 6 * (Q == 3) + 12 * (Q == 4) + 16 * (Q == 5) + 25 * (Q == 6) + 33 * (Q == 7) + 42 * (Q == 8) + 55 * (Q == 9) + 67 * (Q == 10) + 79 * (Q == 11) + 96 * (Q == 12) + 112 * (Q == 13);
  ...
  public:
    ...
    void init(std::span<const T> alpha)
    {
      ...
      std::cout << std::format("Table size = {}, qxn: {}x{}", phi_table.size(),
                ...
                << std::endl;
      assert(shape[0] == 1 && shape[3] == 1);
      constexpr int nq = 14 * (P == 1) + 24 * (P == 2) + 45 * (P == 3) +
                         74 * (P == 4) + 122 * (P == 5) + 177 * (P == 6) +
                         729 * (P == 7) + 1000 * (P == 8) + 1331 * (P == 9);
      // constexpr int nq = 27;
      // constexpr int nq = 8;
      assert(nq == shape[1]);
